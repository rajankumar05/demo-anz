...
/**
 * Transformer: ANZ NZ Dynamic Media / Scene7 image handling.
 * Runs in afterTransform ONLY (block parsers extract <img> into block cells
 * between the hooks; rewriting to anchors earlier would empty those cells).
 * Rewrites DM/Scene7 <img> tags into anchors that round-trip through markdown:
 *   - unlinked <img>          -> <a href="DM-URL">alt</a>
 *   - linked   <a><img></a>   -> <a href="/page" title="DM-URL">alt</a>
 * A companion auto-block in scripts/scripts.js rebuilds these into responsive
 * <picture> elements at render time.
 * Source contains Scene7 IS/Image URLs (e.g. https://assets.anz.co.nz/is/image/anznz/...),
 * confirmed via migration-work/metadata.json .images.mapping.
 */
...
function detectDynamicMediaUrl(urlStr) {
  ...
  // assets.anz.co.nz). Keep byte-identical with dm-scene7-helpers.js.
