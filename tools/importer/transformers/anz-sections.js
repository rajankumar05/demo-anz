...
/**
 * Transformer: ANZ NZ section breaks + section metadata for the "personal" template.
 * Inserts <hr> before every non-first section (in beforeTransform, while all
 * section elements still exist) and a "Section Metadata" block after each styled
 * section (in afterTransform, anchored to a surviving marker <hr>).
 * Section selectors come from page-templates.json and are verified in cleaned.html.
 * Only section-4 ("Scams alert callout") carries a style ("grey").
 */
